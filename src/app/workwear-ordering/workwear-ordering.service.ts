...
export class WorkwearOrderingService {
	...
	private get url() {
		return this.global.backendURL + '/workwears/orderings';
	}
	...
	save(workwearId: number) {
		return this.http.post(
			this.url,
			"",
			{
				headers: this.global.headersToken,
				params: new HttpParams().appendAll({workwearId: workwearId})
			},
		)
	}
